...
@Slf4j
@SpringBootApplication(scanBasePackages = "uz.narzullaev.cardtrx.*")
public class CardTrxApplication {

    public static void main(String[] args) {
        var app = new SpringApplication(CardTrxApplication.class);
